function Invoke-ListSafeAttachmentsFilters {
    ...
    $Policies = New-ExoRequest -tenantid $TenantFilter -cmdlet 'Get-SafeAttachmentPolicy' -AsApp | Select-Object -Property *
    $Rules = New-ExoRequest -tenantid $TenantFilter -cmdlet 'Get-SafeAttachmentRule' -AsApp | Select-Object -Property *
