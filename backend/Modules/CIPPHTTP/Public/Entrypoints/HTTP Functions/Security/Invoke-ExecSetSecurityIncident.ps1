Function Invoke-ExecSetSecurityIncident {
    ...
    try {
        ...
        if ($Redirected -lt 1) {
            ...
            New-GraphPOSTRequest -uri "https://graph.microsoft.com/beta/security/incidents/$IncidentFilter" -type PATCH -tenantid $TenantFilter -body $AssignBody -asApp $true -AsApp $true
