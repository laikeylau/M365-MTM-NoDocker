                ...
                <CippImageCard
                  ...
                  title={
                    <Typography variant="h4" component="h1" gutterBottom>
                      ...
                      M365 MTM API Unreachable
                    </Typography>
                  }
                  text={
                    <Box sx={{ mt: 2 }}>
                      <Typography variant="body1">
                        The M365 MTM API appears to be offline or out of date.
                        {apiVersion && (
                          <Typography
                            component="span"
                      ...
                      <Typography variant="body1" sx={{ mt: 2 }}>
                        If you are self-hosting M365 MTM, please ensure your Function App is running and
