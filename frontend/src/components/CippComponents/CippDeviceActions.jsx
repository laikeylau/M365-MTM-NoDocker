...
/**
 * Canonical row actions for Intune managed devices (B3).
 * Shared by /endpoint/MEM/devices and the report centre (managed-devices report).
 * Action payloads map to /api/ExecDeviceAction etc. — see MEM devices page history.
 */
export const useCippDeviceActions = () => {
  ...
  return [
    ...
    },
    {
      ...
      confirmText: 'Are you sure you want to update the Windows Defender signatures for [deviceName]?',
    },
    {
      ...
      condition: (row) => row.operatingSystem === 'Windows',
      confirmText: 'Are you sure you want to generate logs for device [deviceName] and ship these to MEM?',
    },
    {
...
export default useCippDeviceActions
